...
enum inputs {
    ...
    static let brownL = ColorAsset(name: "brownL")
    static let gradientDown = ColorAsset(name: "gradientDown")
    static let gradientUp = ColorAsset(name: "gradientUp")
    static let grayL = ColorAsset(name: "grayL")
    static let arrow = ImageAsset(name: "arrow")
    static let arrow2 = ImageAsset(name: "arrow2")
    static let backArrow = ImageAsset(name: "backArrow")
    static let chevronDown = ImageAsset(name: "chevronDown")
    static let chevronUp = ImageAsset(name: "chevronUp")
    static let darkGreen = ColorAsset(name: "darkGreen")
    static let favourite = ImageAsset(name: "favourite")
    static let favourites2 = ImageAsset(name: "favourites2")
    static let film = ImageAsset(name: "film")
    static let heartSaved = ImageAsset(name: "heartSaved")
    static let heartUnsaved = ImageAsset(name: "heartUnsaved")
}
